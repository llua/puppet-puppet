...
class puppet::server::puppetserver (
  ...
  if $facts['os']['family'] == 'FreeBSD' {
    $server_gem_paths = [ '${jruby-puppet.gem-home}', "\"${server_puppetserver_vardir}/vendored-jruby-gems\"", "/usr/local/lib/ruby/gems/3.0"] # lint:ignore:single_quote_string_with_variables
